...
import type { AudioRegion, SpeedRegion, TrimRegion } from "@/features/project";
import { resolveMediaElementSource } from "./LocalMediaSourceAdapter";
import type { VideoMuxer } from "./VideoMuxerAdapter";
			...
			await new Promise<void>((resolve, reject) => {
				...
				const tick = () => {
					...
					const anyTrackSoloed =
						masterAudioSoloed || audioRegionElements.some((e) => e.region.soloed);
