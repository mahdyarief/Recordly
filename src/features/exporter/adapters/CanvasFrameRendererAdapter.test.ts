...
import { DEFAULT_WEBCAM_OVERLAY } from "@/features/editor/types";
...
vi.mock("@/shared/lib/assetPath", () => (
{
	getAssetPath: vi.fn(async (value: string) => value), getRenderableAssetUrl;
	: vi.fn((value: string) => value),
}
))

vi.mock("@/features/editor/components/VideoEditor/videoPlayback/zoomRegionUtils", () => (
{
...
vi.mock("@/features/editor/components/VideoEditor/videoPlayback/zoomTransform", () => (
{
	applyZoomTransform: vi.fn(), computeFocusFromTransform;
	: vi.fn(() => (
	{
		cx: 0.5, cy;
		: 0.5
...
vi.mock("@/features/editor/components/VideoEditor/videoPlayback/cursorRenderer", () => (
{
