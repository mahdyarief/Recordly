import { normalizeProjectEditor, ProjectEditorState } from "./ProjectState";
...
export function normalizeEditorPreferences(
	...
	const candidateControls: Partial<ProjectEditorState> = {
	...
	const normalized = normalizeProjectEditor(candidateControls);
