import type { AutoCaptionAnimation, AutoCaptionSettings } from "./AutoCaptionSettings";
import type { CaptionCue, CaptionCueWord } from "./CaptionCue";
...
export interface CaptionPageLayout {
