import { AppWindow, Monitor, Video } from "lucide-react";
...
export function SourceSelector() {
	...
	return (
		<div
			className={`h-full flex flex-col items-center bg-zinc-950 select-none overflow-hidden ${styles.glassContainer}`}
		>
				...
				>
					...
					<div className="h-56 flex flex-col justify-stretch overflow-hidden">
						...
						<TabsContent value="windows" className="h-full mt-0">
							<p className="text-[10px] text-zinc-500 mb-1 px-1 shrink-0">
			...
			<div className="border-t border-zinc-900 p-6 w-full bg-[#08080a] shrink-0">
				<div className="flex flex-col gap-4 max-w-lg mx-auto">
					{selectedSource ? (
						<div
							className={`flex flex-col gap-3 transition-all duration-300 ${selectedSource.sourceType === "window" ? "opacity-40 grayscale pointer-events-none" : "opacity-100"}`}
						>
							<div className="flex items-center justify-between px-1">
								<span className="text-[10px] uppercase tracking-[0.25em] text-blue-500/80 font-black">
